...
var CountdownImageFolder = "../images/cuentaAtras/";
var CountdownImageBasename = "flipper";
var CountdownImageExt = "png";
var CountdownImagePhysicalWidth = 41;
var CountdownImagePhysicalHeight = 60;

var CountdownWidth = 260;
...
Array.prototype.indexOf || (Array.prototype.indexOf = function (t) {
    ...
    var e = Array.prototype.slice.call(arguments, 1), r = this, n = function () {}, i = function () {
    ...
    "use strict";
    var t = function () {}, e = (Array.prototype.indexOf, Object.prototype.toString), r = String.prototype.trim;
    t.link = function (t, e, r) {
        r = r || {};
        var n = e || "_blank", i = [];
        for (var o in r)
            o = o.toLowerCase(), "width" == o || "height" == o || "left" == o ? i.push(o + "=" + r[o]) : "location" != o && "menubar" != o && "resizable" != o && "scrollbars" != o && "status" != o && "titlebar" != o && "toolbar" != o || i.push(o + "=1");
        var a = null;
        ...
        if (t) {
            for (var e, r, n = t.length; n; )
                r = Math.floor(Math.random() * n--), e = t[n], t[n] = t[r], t[r] = e;
            return t
        }
        return[]
        ...
        if (t) {
            ...
            for (var o = jbeeb.Browser.touch; t && !isNaN(t.offsetLeft) && !isNaN(t.offsetTop); )
                o ? (e += (t.offsetLeft || 0) - (t.scrollLeft || 0), r += (t.offsetTop || 0) - (t.scrollTop || 0)) : (e += t.offsetLeft || 0, r += t.offsetTop || 0), t = t.offsetParent;
            if (o) {
                var a = null != window.scrollX ? window.scrollX : window.pageXOffset, u = null != window.scrollY ? window.scrollY : window.pageYOffset;
                e += a, r += u
            }
        }
...
this.jbeeb = this.jbeeb || {}, function () {
    ...
    var i = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame, e = window.performance && (performance.now || performance.mozNow || performance.msNow || performance.oNow || performance.webkitNow), n = function (t) {
    ...
    s.addEventListener = null, s.removeEventListener = null, s.removeAllEventListeners = null, s.dispatchEvent = null, s.hasEventListener = null, jbeeb.EventDispatcher.initialize(s), s.l = 50, s.k = 0, s.d = null, s.q = null, s.h = null, s.c = !1, s.state = 0, s.init = function (t) {
        ...
        var i = t(), e = i - this.k;
        for (this.k = i, this.dispatchEvent("tick", {delta:e, time:i}), this.d.unshift(i); this.d.length > 100; )
            this.d.pop()
    }, s.toString = function () {
        return"[Ticker]"
...
this.jbeeb = this.jbeeb || {}, function () {
    ...
    if (!jbeeb.Browser) {
        ...
        var n = !1, m = "animation", c = "", d = "Webkit Moz O ms Khtml".split(" "), l = "", b = document.createElement("div");
...
this.jbeeb = this.jbeeb || {}, function () {
    ...
    var t = function (t, l) {
        function n(t, l) {
            ...
            var A = f, B = c;
            return h ? (f += b, c += b) : (f += b + ("" != b ? "/" : ""), c += b + ("" != b ? "/" : ""), u = b, g || v || "/" == s.substr(-1) || (s += "/")), p === !1 && ("/" == A.substr(-1) && (A = A.substr(0, A.length - 1)), "/" == B.substr(-1) && (B = B.substr(0, B.length - 1)), h || ("/" == f.substr(-1) && (f = f.substr(0, f.length - 1)), "/" == c.substr(-1) && (c = c.substr(0, c.length - 1)), "/" == s.substr(-1) && (s = s.substr(0, s.length - 1)))), {source: t || null, url: s || null, protocol: e || null, domain: r || null, port: i || null, basename: u || null, ext: h || null, filename: b || null, path: f || null, pathurl: c || null, parent: A || null, parenturl: B || null, query: g || null, fragment: v || null, username: m || null, password: j || null, host: d || null}
        }
        function s(t) {
...
this.jbeeb = this.jbeeb || {}, function () {
    ...
    e.w = 0, e.r = [], e.v = [], e.scriptPath = null, e.x = function (b) {
        ...
        if (!jbeeb.amReady) {
            jbeeb.ticker = new jbeeb.Ticker({interval: jbeeb.tickerInterval, startNow: 1}), jbeeb.assetsBasePath || (jbeeb.assetsBasePath = "");
    ...
    e.addEventListener = null, e.removeEventListener = null, e.removeAllEventListeners = null, e.dispatchEvent = null, e.hasEventListener = null, jbeeb.EventDispatcher.initialize(e), e.amStage = null, e.element = null, e.style = null, e.O = null, e.alpha = 1, e.id = null, e.name = null, e.parent = null, e.stage = null, e.rotation = 0, e.scale = 1, e.scaleX = 1, e.scaleY = 1, e.stretchX = 1, e.stretchY = 1, e.skewX = 0, e.skewY = 0, e.origin = null, e.originX = 0, e.originY = 0, e.originType = "px", e.shadow = null, e.bevel = null, e.outline = null, e.inset = null, e.visible = !0, e.overflow = "visible", e.autoCenter = null, e.x = 0, e.y = 0, e.width = 0, e.height = 0, e.flex = "wh", e.L = 1, e.M = 1, e.pin = null, e.D = null, e.C = null, e.z = 0, e.temp = null, e.rounded = null, e.fill = null, e.stroke = null, e.image = null, e.gradient = null, e.P = null, e.init = function (t) {
        ...
        if (t) {
            ...
            if (o) {
                ...
                if (c.modern) {
                    ...
                    if ("" == x)
                        v = "linear-", S = ("v" == u ? "to bottom, " : "to right, ") + d.join(",");
                    else if ("webkit" == x && g) {
                        var y = p.join(",");
                        v = "-webkit-", S = "v" == u ? "linear, left top, left bottom, " + y : "linear, left top, right top, " + y
                    } else
                        v = "-" + x + "-linear-", S = ("v" == u ? "top, " : "left, ") + d.join(",");
                    e = v + "gradient(" + S + ")"
                } else if (c.ie && c.version < 9) {
                    var w = "v" == u ? "0" : "1", k = "progid:DXImageTransform.Microsoft.gradient( gradientType=" + w + ", startColorstr='" + a[0] + "', endColorstr='" + a[a.length - 3] + "')";
        ...
        if (e == [] && i == [] && s == [] && h == [])
            ...
            for (var o = i.concat(s, h, e), r = o.length, l = [], a = [], u = 0, c = 0; c < r; c++)
                0 == u ? 1 == o[c] && a.push("inset") : u < 4 ? a.push(o[c] + "px") : (a.push(jbeeb.Utils.makeColor(o[c], o[c + 1])), l.push(a.join(" ")), a = [], ++c, u = -1), u++;
            l.length > 0 && (n = l.join(","))
        }
        ...
        t && (jbeeb.Utils.isNumber(t) ? t = {x: -t, y: -t, s1: 0, s2: 0, c1: "#FFFFFF", c2: "#000000", a1: 1, a2: 1} : (t.c1 = t.c1 || "#FFFFFF", t.c2 = t.c2 || "#000000")), this.bevel = t, this.A()
    }, e.I = function () {
        if (this.outline) {
            var t = this.outline;
...
this.jbeeb = this.jbeeb || {}, function () {
    ...
    e.textFit = null, e.text = "", e.ab = "", e.textSize = null, e.textColor = null, e.shadowText = null, e.bevelText = null, e.outlineText = null, e.insetText = null, e.font = null, e.align = null, e.textScale = null, e.selectable = null, e.bold = null, e.padding = null, e.editable = null, e.ak = null, e.multiline = null, e.baselineShift = null, e.ar = null, e.ag = null, e.aa = !1, e.ap = e.init, e.init = function (t) {
        ...
        if (this.aa = !0, t.editable) {
            var i = null;
            t.fill && (i = "object" == typeof t.fill ? t.fill.color : t.fill), t.stroke = t.stroke || i || {weight: 1, color: "#000000", alpha: 1}
        }
        this.aq(t, e);
        this.style;
        if (this.textFit = t.textFit || null, this.font = t.font || "Arial, Helvetica, sans-serif", this.align = t.align || "left", this.textScale = t.textScale || 1, this.bold = t.bold || 0, this.selectable = t.selectable || 0, this.editable = t.editable || 0, this.multiline = t.multiline || 0, this.baselineShift = t.baselineShift || 0, e || (this.text = t.text || ""), this.ab = "", this.textColor = {}, t.textSize && (this.textSize = t.textSize), 1 == t.editable && this.setEditable(1), this.setMultiline(this.multiline, !0), this.setText(this.text), t.textColor) {
            var s = t.textColor, h = {};
            "string" == typeof s ? h = {color: s, alpha: 1} : (h = s, h.color || (h.color = null, h.alpha = null)), this.setTextColor(h.color || "#000000", h.alpha || 1)
        }
        ...
        var t = this.font, e = this.textColor || {}, i = jbeeb.Utils.makeColor(e.color, e.alpha), s = this.bold ? "bold" : "normal", h = this.style;
        ...
        if (this.element) {
            if (t = "" != t && t ? String(t) : "", this.text = t, this.ak && !this.multiline)
        ...
        if (t == [] && e == [] && i == [] && s == [])
            ...
            for (var n = e.concat(i, t, s), l = n.length, o = [], a = [], d = 0, r = 0; r < l; r++)
                0 == d ? 1 == n[r] && a.push("inset") : d < 4 ? a.push(n[r] + "px") : (a.push(jbeeb.Utils.makeColor(n[r], n[r + 1])), o.push(a.join(" ")), a = [], ++r, d = -1), d++;
            o.length > 0 && (h = o.join(","))
        }
        var u = this.style;
    ...
    e.at = [], e.addChild = function (t) {
        ...
        if (this.at)
            for (var t = this.at.length; t--; )
                this.at[t] && (this.at[t].destroy(), this.removeChild(this.at[t]), this.at[t] = null);
...
this.jbeeb = this.jbeeb || {}, function () {
    ...
    e.amReady = null, e.ay = null, e.aA = function (t) {
        if (t)
            if (this.amReady = 0, t.onReady && (this.ay = [], this.ay.push(t.onReady)), this.id = jbeeb.getUID(), t.stage)
                this.amStage = 0, this.aB(t), jbeeb.register(this);
            else {
...
this.jbeeb = this.jbeeb || {}, function () {
    ...
    var s = 6e4, o = 36e5, r = 864e5, u = 0, d = 1, aR = 2, h = 3, l = 4, p = 5, c = 6, m = {ms: u, second: d, minute: aR, hour: h, day: l, month: p, year: c}, f = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31], g = function (t) {
    ...
    T.aK = !1, T.aJ = !1, T.aH = null, T.aE = null, T.aC = 0, T.aD = null, T.aL = 0, T.aG = c, T.aN = null, T.aP = null, T.start = function (t, e) {
        ...
        if (t instanceof Date)
            ...
            var r = t.year ? parseInt(t.year) : a.getFullYear(), u = t.month ? parseInt(t.month) - 1 : 0, d = t.day ? parseInt(t.day) : 0, aR = t.hour ? parseInt(t.hour) : 0, h = t.minute ? parseInt(t.minute) : 0, l = t.second ? parseInt(t.second) : 0, p = (t.ampm ? t.ampm : "am").toLowerCase();
            aR < 12 && /p/.test(p) && (aR += 12), n = this.aD ? new Date(Date.UTC(r, u, d, aR, h, l)) : new Date(r, u, d, aR, h, l)
        } else
            i = 1, n = new Date(a.getTime() + 1e3 * (parseInt(t) + 1));
        if (!i && !e && this.aD) {
            var c = 0, m = 0;
        ...
        var a = 0, i = 0, s = 0, c = 0, m = 0, f = 0, g = 0, T = this.aE, U = T.getTime() - e.getTime(), v = Math.floor, C = !1, b = U, y = 0, D = 0, I = 0, w = 0, M = 0, E = 0;
        if (U > 0) {
            ...
            var S = e.getUTCFullYear(), Z = e.getUTCMonth(), j = e.getUTCDate(), k = T.getUTCFullYear(), O = T.getUTCMonth(), Y = T.getUTCDate(), z = j, N = Y, L = 0;
            if (F >= l)
                if (F == l)
                    m = v(w);
                else {
                    var P = e.getUTCHours(), q = e.getUTCMinutes(), x = e.getUTCSeconds(), A = T.getUTCHours(), B = T.getUTCMinutes(), G = T.getUTCSeconds(), J = O == Z ? 0 : -1, K = O + J;
                    K < 0 && (K += 12);
                    var Q = t(K, k);
            ...
            C = !0;
        var et = {ms: a, second: i, minute: s, hour: c, day: m, month: f, year: g, total_ms: b, total_second: y, total_minute: D, total_hour: I, total_day: w, total_month: M, total_year: E, percent: this.aI ? U / this.aI : 1};
        return n(et, this.aL), C && !this.aJ && this.aH && (this.aK = !0, this.aJ = !0, this.aH(this.aE)), et
    }, g.pad = e, g.padObject = n, g.getMonthDays = t, Object.defineProperty(T, "rangeHi", {get: function () {
            return this.aG
        }, set: function (t) {
            this.aG = i(t, c)
        }}), jbeeb.TimeDiff = g
...
!function () {
    var t, e = function (t) {
        ...
        if (t.bkgd) {
            var l = t.bkgd;
            l.color && (e = l.color), l.stroke && l.strokeColor && (i = {weight: l.stroke || 1, color: l.strokeColor, alpha: l.strokeAlpha}), l.shadow && (n = l.shadow), l.rounded && (s = l.rounded)
        }
        this.aX = new jbeeb.Stage({target: t.target, inline: t.inline || !1, w: t.w || t.width || CountdownWidth, h: t.h || t.height || CountdownHeight, rounded: s || null, fill: e || null, stroke: i || null, shadow: n || null}), jbeeb.register(this)
    }, i = {}, n = e.prototype;
    n.bc = null, n.aX = null, n.bt = !1, n.be = null, n.id = null, n.bk = !1, n.aV = null, n.totalFlipDigits = null, n.imageFolder = null, n.imageBasename = "flipper", n.imageExt = "png", n.by = null, n.aW = null, n.bf = "second", n.bq = !1, n.bg = null, n.bp = !1, n.bw = 0, n.bv = 0, n.bz = 0, n.bs = 0, n.bd = [], n.bb = {}, n.bi = 0, n.bh = 0, n.aT = null, n.init = function () {
        ...
        this.aW = {ms: {use: !1, prev: [null, null], ani: [null, null], aniCount: [null, null]}, second: {use: !1, prev: [null, null], ani: [null, null], aniCount: [null, null]}, minute: {use: !1, prev: [null, null], ani: [null, null], aniCount: [null, null]}, hour: {use: !1, prev: [null, null], ani: [null, null], aniCount: [null, null]}, day: {use: !1, prev: [null, null], ani: [null, null], aniCount: [null, null]}, month: {use: !1, prev: [null, null], ani: [null, null], aniCount: [null, null]}, year: {use: !1, prev: [null, null], ani: [null, null], aniCount: [null, null]}};
        var l = ["ms", "second", "minute", "hour", "day", "month", "year"], a = e.rangeLo ? e.rangeLo : "second", o = e.rangeHi ? e.rangeHi : "year";
        ...
        var c = o - a + 1, g = this.height, p = this.width / c, b = this.bq ? 0 : .25 * p, f = .1 * p, y = p - f, v = g - b, C = y * bA;
        ...
        var T = {numbers: {font: "Arial, _sans", color: "#FFFFFF", weight: "normal", bkgd: "flip" == this.aV ? null : {color: ["#000000", 1, 0, "#686868", 1, 50, "#000000", 1, 50, "#535050", 1, 100], alpha: "v"}, rounded: "flip" == this.aV ? null : .18, shadow: null}, labels: {font: "Arial, _sans", color: "#303030", weight: "bold", textScale: 1, offset: 0}};
        if (e.numbers)
        ...
        for (var S = 0, R = [], u = 0; u < l.length; u++) {
            var F = l[u];
            if (this.aW[F].use) {
                this.by[F] = new jbeeb.Container({x: S + f / 2, y: 0, w: y, h: v, rounded: T.numbers.rounded || null, fill: jbeeb.Utils.clone(T.numbers.bkgd) || null, shadow: T.numbers.shadow || null});
                var D = this.by[F];
                if (D.store = {name: F}, this.bb[F] = y, "flip" == this.aV) {
                    var W = (w - 2 * k - 2 * C) / this.totalFlipDigits, B = this.imagePhysicalWidth * (W / this.imagePhysicalWidth), j = this.imagePhysicalHeight * (x / this.imagePhysicalHeight);
                    D.time = new jbeeb.Container({x: 0, y: 0, w: B * this.totalFlipDigits, h: j});
                    for (var A = [], P = 0; P < this.totalFlipDigits; P++) {
                        for (var I = new jbeeb.Container({x: B * P + k * P, y: 0, w: B, h: j}), O = [], z = 0; z < 10; z++) {
                ...
                } else if (D.time = new jbeeb.TextBox({x: 0, y: 0, w: y, h: v, text: "00", textScale: bA, font: T.numbers.font, textColor: T.numbers.color, align: "center"}), D.addChild(D.time), !this.bp) {
                    var Y = .03 * g;
                    D.line = new jbeeb.Box({x: 0, y: 0, w: y, h: Y, fill: "#000000"}), D.addChild(D.line), D.line.center()
                }
                if (this.aX.addChild(D), !this.bq) {
                    var q = this.bg[F], G = g - .7 * b + T.labels.offset;
                    D.labels = new jbeeb.TextBox({x: S, y: G, w: p, h: .7 * b, font: T.labels.font, textScale: T.labels.textScale, textColor: T.labels.color, bold: 1, align: "center", text: q}), this.aX.addChild(D.labels)
                }
        ...
        var J;
        J = e.time ? e.time : {year: e.year || e.years, month: e.month || e.months, day: e.day || e.days, hour: e.hour || e.hours, minute: e.minute || e.minutes, second: e.second || e.seconds, ms: e.second || e.ms, ampm: e.ampm || ""}, this.aS = new jbeeb.TimeDiff({end: J, rangeHi: r, rangeLo: h, timezone: e.timezone, onComplete: this.bu.bind(this), truncate: e.truncate || 0});
        var K = R.length;
        if (this.bm = K, K > 0) {
            this.bo(!0);
            for (var u = 0; u < K; u++) {
