 ...
 *
 * @author Simon
 * Este controlador lo utiliza el administrador para obtener los datos de todos los usuarios
 */
...
public class ControlUsuarios extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/jsp/controlusuarios.jsp").forward(request, response);
    }
